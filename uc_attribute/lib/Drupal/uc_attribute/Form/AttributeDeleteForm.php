...
/**
 * @file
 * Contains \Drupal\uc_attribute\Form\AttributeDeleteForm.
 */
...
class AttributeDeleteForm extends ConfirmFormBase {
  ...
  public function getDescription() {
    ...
    return format_plural($count, 'There is 1 product with this attribute.', 'There are @count products with this attribute.');
  }
  ...
  public function getCancelRoute() {
    return array(
      'route_name' => 'uc_attribute.overview',
    );
  }
